...
csr = {
    ...
    'fast_a_x_hold_en': (0, 0x098, 27, True),
    'fast_a_x_clear_en': (0, 0x09c, 27, True),
    'fast_a_y_hold_en': (0, 0x0a0, 27, True),
    'fast_a_y_clear_en': (0, 0x0a4, 27, True),
    'fast_a_relock_en': (0, 0x0a8, 27, True),
    'fast_a_dx_sel': (0, 0x0ac, 4, True),
    'fast_a_dy_sel': (0, 0x0ad, 4, True),
    'fast_a_rx_sel': (0, 0x0ae, 4, True),
    ...
    'fast_b_x_hold_en': (1, 0x098, 27, True),
    'fast_b_x_clear_en': (1, 0x09c, 27, True),
    'fast_b_y_hold_en': (1, 0x0a0, 27, True),
    'fast_b_y_clear_en': (1, 0x0a4, 27, True),
    'fast_b_relock_en': (1, 0x0a8, 27, True),
    'fast_b_dx_sel': (1, 0x0ac, 4, True),
    'fast_b_dy_sel': (1, 0x0ad, 4, True),
    'fast_b_rx_sel': (1, 0x0ae, 4, True),
