...
csr = {
    ...
    'fast_a_demod_delay': (0, 0x019, 14, True),
    'fast_a_iir_b_z0': (0, 0x01b, 38, True),
    'fast_a_iir_b_a1': (0, 0x020, 25, True),
    'fast_a_iir_b_a2': (0, 0x024, 25, True),
    'fast_a_iir_b_b0': (0, 0x028, 25, True),
    'fast_a_iir_b_b1': (0, 0x02c, 25, True),
    'fast_a_iir_b_b2': (0, 0x030, 25, True),
    'fast_a_x_limit_min': (0, 0x034, 25, True),
    'fast_a_x_limit_max': (0, 0x038, 25, True),
    'fast_a_iir_c_z0': (0, 0x03c, 27, True),
    ...
    'fast_a_iir_d_a1': (0, 0x04d, 18, True),
    'fast_a_iir_d_a2': (0, 0x050, 18, True),
    'fast_a_iir_d_b0': (0, 0x053, 18, True),
    'fast_a_iir_d_b1': (0, 0x056, 18, True),
    'fast_a_iir_d_b2': (0, 0x059, 18, True),
    'fast_a_iir_e_z0': (0, 0x05c, 38, True),
    'fast_a_iir_e_a1': (0, 0x061, 25, True),
    'fast_a_iir_e_a2': (0, 0x065, 25, True),
    'fast_a_iir_e_b0': (0, 0x069, 25, True),
    'fast_a_iir_e_b1': (0, 0x06d, 25, True),
    'fast_a_iir_e_b2': (0, 0x071, 25, True),
    'fast_a_relock_step': (0, 0x075, 24, True),
    'fast_a_relock_run': (0, 0x078, 1, True),
    'fast_a_relock_min': (0, 0x079, 15, True),
    'fast_a_relock_max': (0, 0x07b, 15, True),
    'fast_a_sweep_step': (0, 0x07d, 24, True),
    'fast_a_sweep_min': (0, 0x080, 14, True),
    'fast_a_sweep_max': (0, 0x082, 14, True),
    'fast_a_sweep_run': (0, 0x084, 1, True),
    'fast_a_mod_amp': (0, 0x085, 14, True),
    'fast_a_mod_freq': (0, 0x087, 32, True),
    'fast_a_y_limit_min': (0, 0x08b, 14, True),
    'fast_a_y_limit_max': (0, 0x08d, 14, True),
    'fast_a_x_clr': (0, 0x08f, 1, True),
    'fast_a_x_max': (0, 0x090, 25, False),
    'fast_a_x_min': (0, 0x094, 25, False),
    'fast_a_y_clr': (0, 0x098, 1, True),
    'fast_a_y_max': (0, 0x099, 25, False),
    'fast_a_y_min': (0, 0x09d, 25, False),
    'fast_a_sweep_trigger_clr': (0, 0x0a1, 1, True),
    'fast_a_sweep_trigger_max': (0, 0x0a2, 1, False),
    'fast_a_sweep_trigger_min': (0, 0x0a3, 1, False),
    'fast_a_x_hold_en': (0, 0x0a4, 27, True),
    'fast_a_x_clear_en': (0, 0x0a8, 27, True),
    'fast_a_y_hold_en': (0, 0x0ac, 27, True),
    'fast_a_y_clear_en': (0, 0x0b0, 27, True),
    'fast_a_relock_en': (0, 0x0b4, 27, True),
    ...
    'fast_b_demod_delay': (1, 0x019, 14, True),
    'fast_b_iir_b_z0': (1, 0x01b, 38, True),
    'fast_b_iir_b_a1': (1, 0x020, 25, True),
    'fast_b_iir_b_a2': (1, 0x024, 25, True),
    'fast_b_iir_b_b0': (1, 0x028, 25, True),
    'fast_b_iir_b_b1': (1, 0x02c, 25, True),
    'fast_b_iir_b_b2': (1, 0x030, 25, True),
    'fast_b_x_limit_min': (1, 0x034, 25, True),
    'fast_b_x_limit_max': (1, 0x038, 25, True),
    'fast_b_iir_c_z0': (1, 0x03c, 27, True),
    ...
    'fast_b_iir_d_a1': (1, 0x04d, 18, True),
    'fast_b_iir_d_a2': (1, 0x050, 18, True),
    'fast_b_iir_d_b0': (1, 0x053, 18, True),
    'fast_b_iir_d_b1': (1, 0x056, 18, True),
    'fast_b_iir_d_b2': (1, 0x059, 18, True),
    'fast_b_iir_e_z0': (1, 0x05c, 38, True),
    'fast_b_iir_e_a1': (1, 0x061, 25, True),
    'fast_b_iir_e_a2': (1, 0x065, 25, True),
    'fast_b_iir_e_b0': (1, 0x069, 25, True),
    'fast_b_iir_e_b1': (1, 0x06d, 25, True),
    'fast_b_iir_e_b2': (1, 0x071, 25, True),
    'fast_b_relock_step': (1, 0x075, 24, True),
    'fast_b_relock_run': (1, 0x078, 1, True),
    'fast_b_relock_min': (1, 0x079, 15, True),
    'fast_b_relock_max': (1, 0x07b, 15, True),
    'fast_b_sweep_step': (1, 0x07d, 24, True),
    'fast_b_sweep_min': (1, 0x080, 14, True),
    'fast_b_sweep_max': (1, 0x082, 14, True),
    'fast_b_sweep_run': (1, 0x084, 1, True),
    'fast_b_mod_amp': (1, 0x085, 14, True),
    'fast_b_mod_freq': (1, 0x087, 32, True),
    'fast_b_y_limit_min': (1, 0x08b, 14, True),
    'fast_b_y_limit_max': (1, 0x08d, 14, True),
    'fast_b_x_clr': (1, 0x08f, 1, True),
    'fast_b_x_max': (1, 0x090, 25, False),
    'fast_b_x_min': (1, 0x094, 25, False),
    'fast_b_y_clr': (1, 0x098, 1, True),
    'fast_b_y_max': (1, 0x099, 25, False),
    'fast_b_y_min': (1, 0x09d, 25, False),
    'fast_b_sweep_trigger_clr': (1, 0x0a1, 1, True),
    'fast_b_sweep_trigger_max': (1, 0x0a2, 1, False),
    'fast_b_sweep_trigger_min': (1, 0x0a3, 1, False),
    'fast_b_x_hold_en': (1, 0x0a4, 27, True),
    'fast_b_x_clear_en': (1, 0x0a8, 27, True),
    'fast_b_y_hold_en': (1, 0x0ac, 27, True),
    'fast_b_y_clear_en': (1, 0x0b0, 27, True),
    'fast_b_relock_en': (1, 0x0b4, 27, True),
    'fast_b_dx_sel': (1, 0x0b8, 5, True),
    'fast_b_dy_sel': (1, 0x0b9, 5, True),
    'fast_b_rx_sel': (1, 0x0ba, 5, True),
