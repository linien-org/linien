...
class SweepControlWidget(QtWidgets.QWidget):
    ...
    def on_connection_established(self):
        ...
        self.parameters.sweep_center.register_listener(self.display_sweep_status)
        self.parameters.sweep_amplitude.register_listener(self.display_sweep_status)
        self.parameters.sweep_pause.register_listener(self.display_sweep_status)
