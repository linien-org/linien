...
class OptimizationPanel(QtWidgets.QWidget):
    ...
    def on_connection_established(self):
        ...
        self.parameters.optimization_running.register_listener(opt_running_changed)
        self.parameters.optimization_approaching.register_listener(opt_running_changed)
        self.parameters.optimization_failed.register_listener(opt_running_changed)
        ...
        self.parameters.optimization_selection.register_listener(opt_selection_changed)
        ...
        for p in (
            ...
            p.register_listener(mod_param_changed)

        def improvement_changed(improvement):
            self.optimization_improvement.setText("%d %%" % (improvement * 100))

        self.parameters.optimization_improvement.register_listener(improvement_changed)
        ...
        self.parameters.dual_channel.register_listener(dual_channel_changed)
