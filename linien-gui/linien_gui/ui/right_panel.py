...
class RightPanel(QtWidgets.QWidget):
    ...
    def on_connection_established(self):
        ...
        self.parameters.autolock_running.register_listener(self.autolock_status_changed)
        self.parameters.optimization_running.register_listener(
            self.optimization_status_changed
        )
        self.parameters.lock.register_listener(self.enable_or_disable_panels)
        ...
        self.parameters.lock.register_listener(highlight_psd_button)
