...
class LockingPanel(QtWidgets.QWidget):
    ...
    def on_connection_established(self):
        ...
        self.parameters.pid_on_slow_enabled.add_listener(slow_pid_visibility)
        ...
        for param in (
            ...
            param.add_listener(lock_status_changed)
        ...
        self.parameters.autolock_selection.add_listener(
