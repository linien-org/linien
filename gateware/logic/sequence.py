...
class SequenceExecutor(Module, AutoCSR):
    ...
    def __init__(self, width=14, data_width=32, max_blocks=16,
                 fsm_addr_width=8, awg_addr_width=10):
        ...
        self.specials += Instance(
            ...
            i_clk=Signal(),   # auto-connected by Migen
            i_rst_n=Signal(),  # wire to platform reset
