...
class PSDAcquisition:
    ...
    def react_to_new_signal(self, data_pickled):
        try:
            ...
            logger.debug("recorded signal for decimation", current_decimation)
            logger.debug("recording took", time() - self.time_decimation_set, "s")
            ...
            if not complete:
                ...
                logger.debug("set new decimation", new_decimation)
...
class PIDOptimization:
    ...
    def psd_data_received(self, psd_data_pickled):
        try:
            ...
            logger.debug("received fitness", psd_data["fitness"], params)
