...
def flash_fpga():
    ...
    # on redpitaya os < 2, flashing fpga works by copying the bit file
    # /dev/xdevcfg. On recent versions, there is a dedicated command for this
    ...
    if fpga_dev_file.exists():
        ...
        subprocess.Popen(["fpgautil", "-b", str(filepath)])
