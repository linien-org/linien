...
csr = {
    ...
    'fast_a_fastchain_clr': (0, 0x077, 1, True),
    'fast_a_fastchain_max': (0, 0x078, 25, False),
    'fast_a_fastchain_min': (0, 0x07c, 25, False),
    'fast_a_fastchain_sel': (0, 0x080, 4, True),
    ...
    'fast_b_fastchain_clr': (1, 0x077, 1, True),
    'fast_b_fastchain_max': (1, 0x078, 25, False),
    'fast_b_fastchain_min': (1, 0x07c, 25, False),
    'fast_b_fastchain_sel': (1, 0x080, 4, True),
    ...
    'logic_linienlogic_clr': (8, 0x140, 1, True),
    'logic_linienlogic_max': (8, 0x141, 25, False),
    'logic_linienlogic_min': (8, 0x145, 25, False),
    'scopegen_external_trigger': (6, 0x000, 1, True),
    'scopegen_scopegen_clr': (6, 0x001, 1, True),
    'scopegen_scopegen_max': (6, 0x002, 25, False),
    'scopegen_scopegen_min': (6, 0x006, 25, False),
    'scopegen_scopegen_sel': (6, 0x00a, 4, True),
    ...
    'slow_chain_slowchain_clr': (2, 0x00d, 1, True),
    'slow_chain_slowchain_max': (2, 0x00e, 25, False),
    'slow_chain_slowchain_min': (2, 0x012, 25, False),
...
states = ['force', 'di0', 'di1', 'di2', 'di3', 'di4', 'di5', 'di6', 'di7', 'robustrobustautolock', 'robustrobustautolock', 'robustrobustautolock', 'robustrobustautolock', 'robustrobustautolock']
signals = ['zero', 'fast_a_fastchain', 'fast_a_fastchain', 'fast_a_fastchain', 'fast_b_fastchain', 'fast_b_fastchain', 'fast_b_fastchain', 'slow_chain_slowchain', 'scopegen_scopegen', 'scopegen_scopegen', 'logic_linienlogic', 'logic_linienlogic', 'logic_linienlogic']
