...
csr = {
    ...
    'logic_sequence_fsm_reg_addr': (8, 0x112, 8, True),
    'logic_sequence_fsm_reg_data': (8, 0x113, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x117, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x118, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x11a, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x11c, 1, True),
    'logic_sequence_num_blocks': (8, 0x11d, 4, True),
    'logic_sequence_init_v': (8, 0x11e, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x120, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x124, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x128, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x12c, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x130, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x134, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x138, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x13c, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x140, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x144, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x148, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x14c, 25, True),
    'logic_control_signal_clr': (8, 0x150, 1, True),
    'logic_control_signal_max': (8, 0x151, 25, False),
    'logic_control_signal_min': (8, 0x155, 25, False),
    'logic_combined_error_signal_clr': (8, 0x159, 1, True),
    'logic_combined_error_signal_max': (8, 0x15a, 25, False),
    'logic_combined_error_signal_min': (8, 0x15e, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x162, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x163, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x167, 25, False),
