...
csr = {
    ...
    'logic_sequence_arm': (8, 0x110, 1, True),
    'logic_sequence_status': (8, 0x111, 2, False),
    'logic_sequence_saved_pid_out': (8, 0x112, 14, False),
    'logic_sequence_saved_integrator': (8, 0x114, 25, False),
    'logic_sequence_saved_sweep_pos': (8, 0x118, 14, False),
    'logic_sequence_saved_dac_out': (8, 0x11a, 14, False),
    'logic_sequence_fsm_reg_addr': (8, 0x11c, 8, True),
    'logic_sequence_fsm_reg_data': (8, 0x11d, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x121, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x122, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x124, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x126, 1, True),
    'logic_sequence_num_blocks': (8, 0x127, 4, True),
    'logic_sequence_init_v': (8, 0x128, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x12a, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x12e, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x132, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x136, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x13a, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x13e, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x142, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x146, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x14a, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x14e, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x152, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x156, 25, True),
    'logic_control_signal_clr': (8, 0x15a, 1, True),
    'logic_control_signal_max': (8, 0x15b, 25, False),
    'logic_control_signal_min': (8, 0x15f, 25, False),
    'logic_combined_error_signal_clr': (8, 0x163, 1, True),
    'logic_combined_error_signal_max': (8, 0x164, 25, False),
    'logic_combined_error_signal_min': (8, 0x168, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x16c, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x16d, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x171, 25, False),
