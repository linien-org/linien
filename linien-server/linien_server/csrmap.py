...
csr = {
    ...
    'logic_relock_watcher_lock_lost': (8, 0x110, 1, False),
    'logic_relock_watcher_should_watch_control': (8, 0x111, 14, True),
    'logic_relock_watcher_min_control': (8, 0x113, 14, True),
    'logic_relock_watcher_max_control': (8, 0x115, 14, True),
    'logic_relock_watcher_should_watch_error': (8, 0x117, 14, True),
    'logic_relock_watcher_min_error': (8, 0x119, 14, True),
    'logic_relock_watcher_max_error': (8, 0x11b, 14, True),
    'logic_relock_watcher_should_watch_monitor': (8, 0x11d, 14, True),
    'logic_relock_watcher_min_monitor': (8, 0x11f, 14, True),
    'logic_relock_watcher_max_monitor': (8, 0x121, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x123, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x127, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x12b, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x12f, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x133, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x137, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x13b, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x13f, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x143, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x147, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x14b, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x14f, 25, True),
    'logic_control_signal_clr': (8, 0x153, 1, True),
    'logic_control_signal_max': (8, 0x154, 25, False),
    'logic_control_signal_min': (8, 0x158, 25, False),
    'logic_combined_error_signal_clr': (8, 0x15c, 1, True),
    'logic_combined_error_signal_max': (8, 0x15d, 25, False),
    'logic_combined_error_signal_min': (8, 0x161, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x165, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x166, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x16a, 25, False),
