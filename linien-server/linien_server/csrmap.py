...
csr = {
    ...
    'logic_relock_watcher_should_watch_control': (8, 0x111, 1, True),
    'logic_relock_watcher_min_control': (8, 0x112, 1, True),
    'logic_relock_watcher_max_control': (8, 0x113, 1, True),
    'logic_relock_watcher_should_watch_error': (8, 0x114, 1, True),
    'logic_relock_watcher_min_error': (8, 0x115, 1, True),
    'logic_relock_watcher_max_error': (8, 0x116, 1, True),
    'logic_relock_watcher_should_watch_monitor': (8, 0x117, 1, True),
    'logic_relock_watcher_min_monitor': (8, 0x118, 1, True),
    'logic_relock_watcher_max_monitor': (8, 0x119, 1, True),
    'logic_raw_acquisition_iir_z0': (8, 0x11a, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x11e, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x122, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x126, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x12a, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x12e, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x132, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x136, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x13a, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x13e, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x142, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x146, 25, True),
    'logic_control_signal_clr': (8, 0x14a, 1, True),
    'logic_control_signal_max': (8, 0x14b, 25, False),
    'logic_control_signal_min': (8, 0x14f, 25, False),
    'logic_combined_error_signal_clr': (8, 0x153, 1, True),
    'logic_combined_error_signal_max': (8, 0x154, 25, False),
    'logic_combined_error_signal_min': (8, 0x158, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x15c, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x15d, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x161, 25, False),
