...
csr = {
    ...
    'fast_a_brk': (0, 0x000, 1, True),
    'fast_a_y_tap': (0, 0x001, 2, True),
    ...
    'fast_a_iir_e_z0': (0, 0x037, 52, True),
    'fast_a_iir_e_a1': (0, 0x03e, 25, True),
    'fast_a_iir_e_a2': (0, 0x042, 25, True),
    'fast_a_iir_e_b0': (0, 0x046, 25, True),
    'fast_a_iir_e_b1': (0, 0x04a, 25, True),
    'fast_a_iir_e_b2': (0, 0x04e, 25, True),
    'fast_a_y_limit_min': (0, 0x052, 25, True),
    'fast_a_y_limit_max': (0, 0x056, 25, True),
    'fast_a_x_clr': (0, 0x05a, 1, True),
    'fast_a_x_max': (0, 0x05b, 25, False),
    'fast_a_x_min': (0, 0x05f, 25, False),
    'fast_a_y_clr': (0, 0x063, 1, True),
    'fast_a_y_max': (0, 0x064, 25, False),
    'fast_a_y_min': (0, 0x068, 25, False),
    'fast_a_x_hold_en': (0, 0x06c, 15, True),
    'fast_a_x_clear_en': (0, 0x06e, 15, True),
    'fast_a_y_hold_en': (0, 0x070, 15, True),
    'fast_a_y_clear_en': (0, 0x072, 15, True),
    'fast_a_dx_sel': (0, 0x074, 4, True),
    'fast_a_dy_sel': (0, 0x075, 4, True),
    'fast_a_rx_sel': (0, 0x076, 4, True),
    'fast_b_brk': (1, 0x000, 1, True),
    'fast_b_y_tap': (1, 0x001, 2, True),
    ...
    'fast_b_iir_e_z0': (1, 0x037, 52, True),
    'fast_b_iir_e_a1': (1, 0x03e, 25, True),
    'fast_b_iir_e_a2': (1, 0x042, 25, True),
    'fast_b_iir_e_b0': (1, 0x046, 25, True),
    'fast_b_iir_e_b1': (1, 0x04a, 25, True),
    'fast_b_iir_e_b2': (1, 0x04e, 25, True),
    'fast_b_y_limit_min': (1, 0x052, 25, True),
    'fast_b_y_limit_max': (1, 0x056, 25, True),
    'fast_b_x_clr': (1, 0x05a, 1, True),
    'fast_b_x_max': (1, 0x05b, 25, False),
    'fast_b_x_min': (1, 0x05f, 25, False),
    'fast_b_y_clr': (1, 0x063, 1, True),
    'fast_b_y_max': (1, 0x064, 25, False),
    'fast_b_y_min': (1, 0x068, 25, False),
    'fast_b_x_hold_en': (1, 0x06c, 15, True),
    'fast_b_x_clear_en': (1, 0x06e, 15, True),
    'fast_b_y_hold_en': (1, 0x070, 15, True),
    'fast_b_y_clear_en': (1, 0x072, 15, True),
    'fast_b_dx_sel': (1, 0x074, 4, True),
    'fast_b_dy_sel': (1, 0x075, 4, True),
    'fast_b_rx_sel': (1, 0x076, 4, True),
    ...
    'root_limit_error_signal_min': (8, 0x021, 14, True),
    'root_limit_error_signal_max': (8, 0x023, 14, True),
    'root_limit_fast1_min': (8, 0x025, 14, True),
    'root_limit_fast1_max': (8, 0x027, 14, True),
    'root_limit_fast2_min': (8, 0x029, 14, True),
    'root_limit_fast2_max': (8, 0x02b, 14, True),
    'root_pid_setpoint': (8, 0x02d, 25, True),
    'root_pid_kp': (8, 0x031, 14, True),
    'root_pid_ki': (8, 0x033, 14, True),
    'root_pid_reset': (8, 0x035, 1, True),
    'root_pid_kd': (8, 0x036, 14, True),
    'root_slow_decimation': (8, 0x038, 5, True),
    'root_control_signal_clr': (8, 0x039, 1, True),
    'root_control_signal_max': (8, 0x03a, 25, False),
    'root_control_signal_min': (8, 0x03e, 25, False),
    'root_combined_error_signal_clr': (8, 0x042, 1, True),
    'root_combined_error_signal_max': (8, 0x043, 25, False),
    'root_combined_error_signal_min': (8, 0x047, 25, False),
