...
csr = {
    ...
    'root_slow_value': (8, 0x00d, 14, False),
    'root_mod_amp': (8, 0x00f, 14, True),
    'root_mod_freq': (8, 0x011, 32, True),
    'root_sweep_step': (8, 0x015, 24, True),
    'root_sweep_min': (8, 0x018, 14, True),
    'root_sweep_max': (8, 0x01a, 14, True),
    'root_sweep_run': (8, 0x01c, 1, True),
    'root_limit_error_signal_min': (8, 0x01d, 14, True),
    'root_limit_error_signal_max': (8, 0x01f, 14, True),
    'root_limit_control_signal_min': (8, 0x021, 14, True),
    'root_limit_control_signal_max': (8, 0x023, 14, True),
    'root_pid_setpoint': (8, 0x025, 14, True),
    'root_pid_kp': (8, 0x027, 14, True),
    'root_pid_ki': (8, 0x029, 14, True),
    'root_pid_reset': (8, 0x02b, 1, True),
    'root_pid_kd': (8, 0x02c, 14, True),
    'root_slow_decimation': (8, 0x02e, 5, True),
    'root_control_signal_clr': (8, 0x02f, 1, True),
    'root_control_signal_max': (8, 0x030, 25, False),
    'root_control_signal_min': (8, 0x034, 25, False),
    'root_combined_error_signal_clr': (8, 0x038, 1, True),
    'root_combined_error_signal_max': (8, 0x039, 25, False),
    'root_combined_error_signal_min': (8, 0x03d, 25, False),
