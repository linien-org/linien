...
csr = {
    ...
    'logic_relock_watcher_lock_lost': (8, 0x10f, 1, False),
    'logic_relock_watcher_should_watch_control': (8, 0x110, 1, True),
    'logic_relock_watcher_min_control': (8, 0x111, 1, True),
    'logic_relock_watcher_max_control': (8, 0x112, 1, True),
    'logic_relock_watcher_should_watch_error': (8, 0x113, 1, True),
    'logic_relock_watcher_min_error': (8, 0x114, 1, True),
    'logic_relock_watcher_max_error': (8, 0x115, 1, True),
    'logic_relock_watcher_should_watch_monitor': (8, 0x116, 1, True),
    'logic_relock_watcher_min_monitor': (8, 0x117, 1, True),
    'logic_relock_watcher_max_monitor': (8, 0x118, 1, True),
    'logic_raw_acquisition_iir_z0': (8, 0x119, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x11d, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x121, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x125, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x129, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x12d, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x131, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x135, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x139, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x13d, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x141, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x145, 25, True),
    'logic_control_signal_clr': (8, 0x149, 1, True),
    'logic_control_signal_max': (8, 0x14a, 25, False),
    'logic_control_signal_min': (8, 0x14e, 25, False),
    'logic_combined_error_signal_clr': (8, 0x152, 1, True),
    'logic_combined_error_signal_max': (8, 0x153, 25, False),
    'logic_combined_error_signal_min': (8, 0x157, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x15b, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x15c, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x160, 25, False),
