...
csr = {
    ...
    'root_mod_amp': (8, 0x005, 14, True),
    'root_mod_freq': (8, 0x007, 32, True),
    'root_sweep_step': (8, 0x00b, 24, True),
    'root_sweep_min': (8, 0x00e, 14, True),
    'root_sweep_max': (8, 0x010, 14, True),
    'root_sweep_run': (8, 0x012, 1, True),
    'root_limit1_min': (8, 0x013, 14, True),
    'root_limit1_max': (8, 0x015, 14, True),
    'root_limit_min': (8, 0x017, 14, True),
    'root_limit_max': (8, 0x019, 14, True),
    'root_pid_setpoint': (8, 0x01b, 14, True),
    'root_pid_kp': (8, 0x01d, 14, True),
    'root_pid_ki': (8, 0x01f, 14, True),
    'root_pid_reset': (8, 0x021, 1, True),
    'root_pid_kd': (8, 0x022, 14, True),
    'root_control_signal_clr': (8, 0x024, 1, True),
    'root_control_signal_max': (8, 0x025, 25, False),
    'root_control_signal_min': (8, 0x029, 25, False),
