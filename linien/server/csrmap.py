...
csr = {
    ...
    "logic_raw_acquisition_iir_z0": (8, 0x10D, 27, True),
    "logic_raw_acquisition_iir_a1": (8, 0x111, 25, True),
    "logic_raw_acquisition_iir_a2": (8, 0x115, 25, True),
    "logic_raw_acquisition_iir_a3": (8, 0x119, 25, True),
    "logic_raw_acquisition_iir_a4": (8, 0x11D, 25, True),
    "logic_raw_acquisition_iir_a5": (8, 0x121, 25, True),
    "logic_raw_acquisition_iir_b0": (8, 0x125, 25, True),
    "logic_raw_acquisition_iir_b1": (8, 0x129, 25, True),
    "logic_raw_acquisition_iir_b2": (8, 0x12D, 25, True),
    "logic_raw_acquisition_iir_b3": (8, 0x131, 25, True),
    "logic_raw_acquisition_iir_b4": (8, 0x135, 25, True),
    "logic_raw_acquisition_iir_b5": (8, 0x139, 25, True),
    "logic_control_signal_clr": (8, 0x13D, 1, True),
    "logic_control_signal_max": (8, 0x13E, 25, False),
    "logic_control_signal_min": (8, 0x142, 25, False),
    "logic_combined_error_signal_clr": (8, 0x146, 1, True),
    "logic_combined_error_signal_max": (8, 0x147, 25, False),
    "logic_combined_error_signal_min": (8, 0x14B, 25, False),
    "logic_combined_error_signal_filtered_clr": (8, 0x14F, 1, True),
    "logic_combined_error_signal_filtered_max": (8, 0x150, 25, False),
    "logic_combined_error_signal_filtered_min": (8, 0x154, 25, False),
