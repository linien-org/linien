...
csr = {
    ...
    'logic_autolock_robust_sign_equal_csr': (8, 0x108, 1, False),
    'logic_autolock_robust_current_instruction_idx_csr': (8, 0x109, 1, False),
    ...
    'logic_control_signal_min': (8, 0x118, 25, False),
    'logic_combined_error_signal_clr': (8, 0x11c, 1, True),
    'logic_combined_error_signal_max': (8, 0x11d, 25, False),
    'logic_combined_error_signal_min': (8, 0x121, 25, False),
    'logic_autolock_robust_test_sum_diff_clr': (8, 0x125, 1, True),
    'logic_autolock_robust_test_sum_diff_max': (8, 0x126, 25, False),
    'logic_autolock_robust_test_sum_diff_min': (8, 0x12a, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_clr': (8, 0x12e, 1, True),
    'logic_autolock_robust_current_peak_height_shifted_max': (8, 0x12f, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_min': (8, 0x133, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_clr': (8, 0x137, 1, True),
    'logic_autolock_robust_current_wait_for_shifted_max': (8, 0x138, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_min': (8, 0x13c, 25, False),
...
states = ['force', 'di0', 'di1', 'di2', 'di3', 'di4', 'di5', 'di6', 'di7', 'robust_watching', 'robust_turn_on_lock', 'robust_sign_equal', 'robust_over_threshold', 'robust_waited_long_enough', 'robust_instruction_idx_at_zero']
signals = ['zero', 'fast_a_x', 'fast_a_out_i', 'fast_a_out_q', 'fast_b_x', 'fast_b_out_i', 'fast_b_out_q', 'slow_out', 'scopegen_dac_a', 'scopegen_dac_b', 'logic_control_signal', 'logic_combined_error_signal', 'robust_test_sum_diff', 'robust_current_peak_height_shifted', 'robust_current_wait_for_shifted']
