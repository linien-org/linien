...
csr = {
    ...
    'root_watcher_threshold': (8, 0x03b, 20, True),
    'root_control_signal_clr': (8, 0x03e, 1, True),
    'root_control_signal_max': (8, 0x03f, 25, False),
    'root_control_signal_min': (8, 0x043, 25, False),
    'root_combined_error_signal_clr': (8, 0x047, 1, True),
    'root_combined_error_signal_max': (8, 0x048, 25, False),
    'root_combined_error_signal_min': (8, 0x04c, 25, False),
