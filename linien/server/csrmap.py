...
csr = {
    ...
    "logic_limit_error_signal_min": (8, 0x029, 25, True),
    "logic_limit_error_signal_max": (8, 0x02D, 25, True),
    "logic_limit_fast1_min": (8, 0x031, 14, True),
    "logic_limit_fast1_max": (8, 0x033, 14, True),
    "logic_limit_fast2_min": (8, 0x035, 14, True),
    "logic_limit_fast2_max": (8, 0x037, 14, True),
    "logic_pid_setpoint": (8, 0x039, 25, True),
    "logic_pid_kp": (8, 0x03D, 14, True),
    "logic_pid_ki": (8, 0x03F, 14, True),
    "logic_pid_reset": (8, 0x041, 1, True),
    "logic_pid_kd": (8, 0x042, 14, True),
    "logic_autolock_robust_time_scale": (8, 0x044, 14, True),
    "logic_autolock_robust_N_instructions": (8, 0x046, 5, True),
    "logic_autolock_robust_final_wait_time": (8, 0x047, 14, True),
    "logic_autolock_robust_peak_height_0": (8, 0x049, 28, True),
    "logic_autolock_robust_peak_height_1": (8, 0x04D, 28, True),
    "logic_autolock_robust_peak_height_2": (8, 0x051, 28, True),
    "logic_autolock_robust_peak_height_3": (8, 0x055, 28, True),
    "logic_autolock_robust_peak_height_4": (8, 0x059, 28, True),
    "logic_autolock_robust_peak_height_5": (8, 0x05D, 28, True),
    "logic_autolock_robust_peak_height_6": (8, 0x061, 28, True),
    "logic_autolock_robust_peak_height_7": (8, 0x065, 28, True),
    "logic_autolock_robust_peak_height_8": (8, 0x069, 28, True),
    "logic_autolock_robust_peak_height_9": (8, 0x06D, 28, True),
    "logic_autolock_robust_peak_height_10": (8, 0x071, 28, True),
    "logic_autolock_robust_peak_height_11": (8, 0x075, 28, True),
    "logic_autolock_robust_peak_height_12": (8, 0x079, 28, True),
    "logic_autolock_robust_peak_height_13": (8, 0x07D, 28, True),
    "logic_autolock_robust_peak_height_14": (8, 0x081, 28, True),
    "logic_autolock_robust_peak_height_15": (8, 0x085, 28, True),
    "logic_autolock_robust_peak_height_16": (8, 0x089, 28, True),
    "logic_autolock_robust_peak_height_17": (8, 0x08D, 28, True),
    "logic_autolock_robust_peak_height_18": (8, 0x091, 28, True),
    "logic_autolock_robust_peak_height_19": (8, 0x095, 28, True),
    "logic_autolock_robust_peak_height_20": (8, 0x099, 28, True),
    "logic_autolock_robust_peak_height_21": (8, 0x09D, 28, True),
    "logic_autolock_robust_peak_height_22": (8, 0x0A1, 28, True),
    "logic_autolock_robust_peak_height_23": (8, 0x0A5, 28, True),
    "logic_autolock_robust_peak_height_24": (8, 0x0A9, 28, True),
    "logic_autolock_robust_peak_height_25": (8, 0x0AD, 28, True),
    "logic_autolock_robust_peak_height_26": (8, 0x0B1, 28, True),
    "logic_autolock_robust_peak_height_27": (8, 0x0B5, 28, True),
    "logic_autolock_robust_peak_height_28": (8, 0x0B9, 28, True),
    "logic_autolock_robust_peak_height_29": (8, 0x0BD, 28, True),
    "logic_autolock_robust_peak_height_30": (8, 0x0C1, 28, True),
    "logic_autolock_robust_peak_height_31": (8, 0x0C5, 28, True),
    "logic_autolock_robust_wait_for_0": (8, 0x0C9, 14, True),
    "logic_autolock_robust_wait_for_1": (8, 0x0CB, 14, True),
    "logic_autolock_robust_wait_for_2": (8, 0x0CD, 14, True),
    "logic_autolock_robust_wait_for_3": (8, 0x0CF, 14, True),
    "logic_autolock_robust_wait_for_4": (8, 0x0D1, 14, True),
    "logic_autolock_robust_wait_for_5": (8, 0x0D3, 14, True),
    "logic_autolock_robust_wait_for_6": (8, 0x0D5, 14, True),
    "logic_autolock_robust_wait_for_7": (8, 0x0D7, 14, True),
    "logic_autolock_robust_wait_for_8": (8, 0x0D9, 14, True),
    "logic_autolock_robust_wait_for_9": (8, 0x0DB, 14, True),
    "logic_autolock_robust_wait_for_10": (8, 0x0DD, 14, True),
    "logic_autolock_robust_wait_for_11": (8, 0x0DF, 14, True),
    "logic_autolock_robust_wait_for_12": (8, 0x0E1, 14, True),
    "logic_autolock_robust_wait_for_13": (8, 0x0E3, 14, True),
    "logic_autolock_robust_wait_for_14": (8, 0x0E5, 14, True),
    "logic_autolock_robust_wait_for_15": (8, 0x0E7, 14, True),
    "logic_autolock_robust_wait_for_16": (8, 0x0E9, 14, True),
    "logic_autolock_robust_wait_for_17": (8, 0x0EB, 14, True),
    "logic_autolock_robust_wait_for_18": (8, 0x0ED, 14, True),
    "logic_autolock_robust_wait_for_19": (8, 0x0EF, 14, True),
    "logic_autolock_robust_wait_for_20": (8, 0x0F1, 14, True),
    "logic_autolock_robust_wait_for_21": (8, 0x0F3, 14, True),
    "logic_autolock_robust_wait_for_22": (8, 0x0F5, 14, True),
    "logic_autolock_robust_wait_for_23": (8, 0x0F7, 14, True),
    "logic_autolock_robust_wait_for_24": (8, 0x0F9, 14, True),
    "logic_autolock_robust_wait_for_25": (8, 0x0FB, 14, True),
    "logic_autolock_robust_wait_for_26": (8, 0x0FD, 14, True),
    "logic_autolock_robust_wait_for_27": (8, 0x0FF, 14, True),
    "logic_autolock_robust_wait_for_28": (8, 0x101, 14, True),
    "logic_autolock_robust_wait_for_29": (8, 0x103, 14, True),
    "logic_autolock_robust_wait_for_30": (8, 0x105, 14, True),
    "logic_autolock_robust_wait_for_31": (8, 0x107, 14, True),
    "logic_autolock_fast_target_position": (8, 0x109, 14, True),
    "logic_autolock_request_lock": (8, 0x10B, 1, True),
    "logic_autolock_autolock_mode": (8, 0x10C, 2, True),
    "logic_autolock_lock_running": (8, 0x10D, 1, False),
    "logic_raw_acquisition_iir_z0": (8, 0x10E, 27, True),
    "logic_raw_acquisition_iir_a1": (8, 0x112, 25, True),
    "logic_raw_acquisition_iir_a2": (8, 0x116, 25, True),
    "logic_raw_acquisition_iir_a3": (8, 0x11A, 25, True),
    "logic_raw_acquisition_iir_a4": (8, 0x11E, 25, True),
    "logic_raw_acquisition_iir_a5": (8, 0x122, 25, True),
    "logic_raw_acquisition_iir_b0": (8, 0x126, 25, True),
    "logic_raw_acquisition_iir_b1": (8, 0x12A, 25, True),
    "logic_raw_acquisition_iir_b2": (8, 0x12E, 25, True),
    "logic_raw_acquisition_iir_b3": (8, 0x132, 25, True),
    "logic_raw_acquisition_iir_b4": (8, 0x136, 25, True),
    "logic_raw_acquisition_iir_b5": (8, 0x13A, 25, True),
    "logic_control_signal_clr": (8, 0x13E, 1, True),
    "logic_control_signal_max": (8, 0x13F, 25, False),
    "logic_control_signal_min": (8, 0x143, 25, False),
    "logic_combined_error_signal_clr": (8, 0x147, 1, True),
    "logic_combined_error_signal_max": (8, 0x148, 25, False),
    "logic_combined_error_signal_min": (8, 0x14C, 25, False),
    "logic_combined_error_signal_filtered_clr": (8, 0x150, 1, True),
    "logic_combined_error_signal_filtered_max": (8, 0x151, 25, False),
    "logic_combined_error_signal_filtered_min": (8, 0x155, 25, False),
