...
csr = {
    ...
    'fast_a_dx_sel': (0, 0x092, 5, True),
    'fast_a_dy_sel': (0, 0x093, 5, True),
    ...
    'fast_b_dx_sel': (1, 0x092, 5, True),
    'fast_b_dy_sel': (1, 0x093, 5, True),
    'gpio_n_ins': (30, 0x000, 8, False),
    'gpio_n_outs': (30, 0x001, 8, True),
    'gpio_n_oes': (30, 0x002, 8, True),
    'gpio_n_state': (30, 0x003, 16, False),
    'gpio_n_state_clr': (30, 0x005, 1, True),
    'gpio_n_do0_en': (30, 0x006, 16, True),
    'gpio_n_do1_en': (30, 0x008, 16, True),
    'gpio_n_do2_en': (30, 0x00a, 16, True),
    'gpio_n_do3_en': (30, 0x00c, 16, True),
    'gpio_n_do4_en': (30, 0x00e, 16, True),
    'gpio_n_do5_en': (30, 0x010, 16, True),
    'gpio_n_do6_en': (30, 0x012, 16, True),
    'gpio_n_do7_en': (30, 0x014, 16, True),
    ...
    'logic_autolock_robust_peak_height_0': (8, 0x046, 28, True),
    'logic_autolock_robust_peak_height_1': (8, 0x04a, 28, True),
    'logic_autolock_robust_peak_height_2': (8, 0x04e, 28, True),
    'logic_autolock_robust_peak_height_3': (8, 0x052, 28, True),
    'logic_autolock_robust_peak_height_4': (8, 0x056, 28, True),
    'logic_autolock_robust_peak_height_5': (8, 0x05a, 28, True),
    'logic_autolock_robust_peak_height_6': (8, 0x05e, 28, True),
    'logic_autolock_robust_peak_height_7': (8, 0x062, 28, True),
    'logic_autolock_robust_peak_height_8': (8, 0x066, 28, True),
    'logic_autolock_robust_peak_height_9': (8, 0x06a, 28, True),
    'logic_autolock_robust_peak_height_10': (8, 0x06e, 28, True),
    'logic_autolock_robust_peak_height_11': (8, 0x072, 28, True),
    'logic_autolock_robust_peak_height_12': (8, 0x076, 28, True),
    'logic_autolock_robust_peak_height_13': (8, 0x07a, 28, True),
    'logic_autolock_robust_peak_height_14': (8, 0x07e, 28, True),
    'logic_autolock_robust_peak_height_15': (8, 0x082, 28, True),
    'logic_autolock_robust_peak_height_16': (8, 0x086, 28, True),
    'logic_autolock_robust_peak_height_17': (8, 0x08a, 28, True),
    'logic_autolock_robust_peak_height_18': (8, 0x08e, 28, True),
    'logic_autolock_robust_peak_height_19': (8, 0x092, 28, True),
    'logic_autolock_robust_peak_height_20': (8, 0x096, 28, True),
    'logic_autolock_robust_peak_height_21': (8, 0x09a, 28, True),
    'logic_autolock_robust_peak_height_22': (8, 0x09e, 28, True),
    'logic_autolock_robust_peak_height_23': (8, 0x0a2, 28, True),
    'logic_autolock_robust_peak_height_24': (8, 0x0a6, 28, True),
    'logic_autolock_robust_peak_height_25': (8, 0x0aa, 28, True),
    'logic_autolock_robust_peak_height_26': (8, 0x0ae, 28, True),
    'logic_autolock_robust_peak_height_27': (8, 0x0b2, 28, True),
    'logic_autolock_robust_peak_height_28': (8, 0x0b6, 28, True),
    'logic_autolock_robust_peak_height_29': (8, 0x0ba, 28, True),
    'logic_autolock_robust_peak_height_30': (8, 0x0be, 28, True),
    'logic_autolock_robust_peak_height_31': (8, 0x0c2, 28, True),
    'logic_autolock_robust_wait_for_0': (8, 0x0c6, 14, True),
    'logic_autolock_robust_wait_for_1': (8, 0x0c8, 14, True),
    'logic_autolock_robust_wait_for_2': (8, 0x0ca, 14, True),
    'logic_autolock_robust_wait_for_3': (8, 0x0cc, 14, True),
    'logic_autolock_robust_wait_for_4': (8, 0x0ce, 14, True),
    'logic_autolock_robust_wait_for_5': (8, 0x0d0, 14, True),
    'logic_autolock_robust_wait_for_6': (8, 0x0d2, 14, True),
    'logic_autolock_robust_wait_for_7': (8, 0x0d4, 14, True),
    'logic_autolock_robust_wait_for_8': (8, 0x0d6, 14, True),
    'logic_autolock_robust_wait_for_9': (8, 0x0d8, 14, True),
    'logic_autolock_robust_wait_for_10': (8, 0x0da, 14, True),
    'logic_autolock_robust_wait_for_11': (8, 0x0dc, 14, True),
    'logic_autolock_robust_wait_for_12': (8, 0x0de, 14, True),
    'logic_autolock_robust_wait_for_13': (8, 0x0e0, 14, True),
    'logic_autolock_robust_wait_for_14': (8, 0x0e2, 14, True),
    'logic_autolock_robust_wait_for_15': (8, 0x0e4, 14, True),
    'logic_autolock_robust_wait_for_16': (8, 0x0e6, 14, True),
    'logic_autolock_robust_wait_for_17': (8, 0x0e8, 14, True),
    'logic_autolock_robust_wait_for_18': (8, 0x0ea, 14, True),
    'logic_autolock_robust_wait_for_19': (8, 0x0ec, 14, True),
    'logic_autolock_robust_wait_for_20': (8, 0x0ee, 14, True),
    'logic_autolock_robust_wait_for_21': (8, 0x0f0, 14, True),
    'logic_autolock_robust_wait_for_22': (8, 0x0f2, 14, True),
    'logic_autolock_robust_wait_for_23': (8, 0x0f4, 14, True),
    'logic_autolock_robust_wait_for_24': (8, 0x0f6, 14, True),
    'logic_autolock_robust_wait_for_25': (8, 0x0f8, 14, True),
    'logic_autolock_robust_wait_for_26': (8, 0x0fa, 14, True),
    'logic_autolock_robust_wait_for_27': (8, 0x0fc, 14, True),
    'logic_autolock_robust_wait_for_28': (8, 0x0fe, 14, True),
    'logic_autolock_robust_wait_for_29': (8, 0x100, 14, True),
    'logic_autolock_robust_wait_for_30': (8, 0x102, 14, True),
    'logic_autolock_robust_wait_for_31': (8, 0x104, 14, True),
    'logic_autolock_robust_sign_equal_csr': (8, 0x106, 1, False),
    'logic_autolock_robust_current_instruction_idx_csr': (8, 0x107, 1, False),
    'logic_autolock_robust_current_peak_height_csr': (8, 0x108, 28, False),
    'logic_autolock_fast_target_position': (8, 0x10c, 14, True),
    'logic_autolock_request_lock': (8, 0x10e, 1, True),
    'logic_autolock_autolock_mode': (8, 0x10f, 1, True),
    'logic_autolock_lock_running': (8, 0x110, 1, False),
    'logic_control_signal_clr': (8, 0x111, 1, True),
    'logic_control_signal_max': (8, 0x112, 25, False),
    'logic_control_signal_min': (8, 0x116, 25, False),
    'logic_combined_error_signal_clr': (8, 0x11a, 1, True),
    'logic_combined_error_signal_max': (8, 0x11b, 25, False),
    'logic_combined_error_signal_min': (8, 0x11f, 25, False),
    'logic_autolock_robust_test_sum_clr': (8, 0x123, 1, True),
    'logic_autolock_robust_test_sum_max': (8, 0x124, 25, False),
    'logic_autolock_robust_test_sum_min': (8, 0x128, 25, False),
    'logic_autolock_robust_test_sum_diff_clr': (8, 0x12c, 1, True),
    'logic_autolock_robust_test_sum_diff_max': (8, 0x12d, 25, False),
    'logic_autolock_robust_test_sum_diff_min': (8, 0x131, 25, False),
    'logic_autolock_robust_waited_for_shifted_clr': (8, 0x135, 1, True),
    'logic_autolock_robust_waited_for_shifted_max': (8, 0x136, 25, False),
    'logic_autolock_robust_waited_for_shifted_min': (8, 0x13a, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_clr': (8, 0x13e, 1, True),
    'logic_autolock_robust_current_peak_height_shifted_max': (8, 0x13f, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_min': (8, 0x143, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_clr': (8, 0x147, 1, True),
    'logic_autolock_robust_current_wait_for_shifted_max': (8, 0x148, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_min': (8, 0x14c, 25, False),
    'logic_autolock_robust_input_shifted_clr': (8, 0x150, 1, True),
    'logic_autolock_robust_input_shifted_max': (8, 0x151, 25, False),
    'logic_autolock_robust_input_shifted_min': (8, 0x155, 25, False),
    ...
    'scopegen_adc_a_q_sel': (6, 0x015, 5, True),
    'scopegen_adc_b_q_sel': (6, 0x016, 5, True),
...
states = ['force', 'di0', 'di1', 'di2', 'di3', 'di4', 'di5', 'di6', 'di7', 'robust_state_always_on', 'robust_watching', 'robust_turn_on_lock', 'robust_sign_equal', 'robust_over_threshold', 'robust_waited_long_enough', 'robust_instruction_idx_at_zero']
signals = ['zero', 'fast_a_x', 'fast_a_out_i', 'fast_a_out_q', 'fast_b_x', 'fast_b_out_i', 'fast_b_out_q', 'slow_out', 'scopegen_dac_a', 'scopegen_dac_b', 'logic_control_signal', 'logic_combined_error_signal', 'robust_test_sum', 'robust_test_sum_diff', 'robust_waited_for_shifted', 'robust_current_peak_height_shifted', 'robust_current_wait_for_shifted', 'robust_input_shifted']
