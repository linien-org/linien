...
csr = {
    ...
    'fast_a_dx_sel': (0, 0x09e, 5, True),
    'fast_a_dy_sel': (0, 0x09f, 5, True),
    'fast_a_rx_sel': (0, 0x0a0, 5, True),
    ...
    'fast_b_dx_sel': (1, 0x09e, 5, True),
    'fast_b_dy_sel': (1, 0x09f, 5, True),
    'fast_b_rx_sel': (1, 0x0a0, 5, True),
    ...
    'root_control_signal_clr': (8, 0x012, 1, True),
    'root_control_signal_max': (8, 0x013, 25, False),
    'root_control_signal_min': (8, 0x017, 25, False),
...
signals = ['zero', 'fast_a_x', 'fast_a_y', 'fast_b_x', 'fast_b_y', 'slow_a_x', 'slow_a_y', 'slow_b_x', 'slow_b_y', 'slow_c_x', 'slow_c_y', 'slow_d_x', 'slow_d_y', 'scopegen_dac_a', 'scopegen_dac_b', 'noise_y', 'root_control_signal']
