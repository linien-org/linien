...
csr = {
    ...
    'logic_autolock_fast_target_position': (8, 0x106, 14, True),
    'logic_autolock_request_lock': (8, 0x108, 1, True),
    'logic_autolock_autolock_mode': (8, 0x109, 1, True),
    'logic_autolock_lock_running': (8, 0x10a, 1, False),
    'logic_control_signal_clr': (8, 0x10b, 1, True),
    'logic_control_signal_max': (8, 0x10c, 25, False),
    'logic_control_signal_min': (8, 0x110, 25, False),
    'logic_combined_error_signal_clr': (8, 0x114, 1, True),
    'logic_combined_error_signal_max': (8, 0x115, 25, False),
    'logic_combined_error_signal_min': (8, 0x119, 25, False),
    'logic_autolock_robust_test_sum_clr': (8, 0x11d, 1, True),
    'logic_autolock_robust_test_sum_max': (8, 0x11e, 25, False),
    'logic_autolock_robust_test_sum_min': (8, 0x122, 25, False),
    'logic_autolock_robust_test_sum_diff_clr': (8, 0x126, 1, True),
    'logic_autolock_robust_test_sum_diff_max': (8, 0x127, 25, False),
    'logic_autolock_robust_test_sum_diff_min': (8, 0x12b, 25, False),
    'logic_autolock_robust_waited_for_shifted_clr': (8, 0x12f, 1, True),
    'logic_autolock_robust_waited_for_shifted_max': (8, 0x130, 25, False),
    'logic_autolock_robust_waited_for_shifted_min': (8, 0x134, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_clr': (8, 0x138, 1, True),
    'logic_autolock_robust_current_peak_height_shifted_max': (8, 0x139, 25, False),
    'logic_autolock_robust_current_peak_height_shifted_min': (8, 0x13d, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_clr': (8, 0x141, 1, True),
    'logic_autolock_robust_current_wait_for_shifted_max': (8, 0x142, 25, False),
    'logic_autolock_robust_current_wait_for_shifted_min': (8, 0x146, 25, False),
    'logic_autolock_robust_input_shifted_clr': (8, 0x14a, 1, True),
    'logic_autolock_robust_input_shifted_max': (8, 0x14b, 25, False),
    'logic_autolock_robust_input_shifted_min': (8, 0x14f, 25, False),
...
states = ['force', 'di0', 'di1', 'di2', 'di3', 'di4', 'di5', 'di6', 'di7', 'robust_state_always_on', 'robust_watching', 'robust_turn_on_lock', 'robust_sign_equal', 'robust_over_threshold', 'robust_waited_long_enough']
