...
csr = {
    ...
    'fast_a_y_limit_min': (0, 0x052, 14, True),
    'fast_a_y_limit_max': (0, 0x054, 14, True),
    'fast_a_x_clr': (0, 0x056, 1, True),
    'fast_a_x_max': (0, 0x057, 25, False),
    'fast_a_x_min': (0, 0x05b, 25, False),
    'fast_a_y_clr': (0, 0x05f, 1, True),
    'fast_a_y_max': (0, 0x060, 25, False),
    'fast_a_y_min': (0, 0x064, 25, False),
    'fast_a_x_hold_en': (0, 0x068, 15, True),
    'fast_a_x_clear_en': (0, 0x06a, 15, True),
    'fast_a_y_hold_en': (0, 0x06c, 15, True),
    'fast_a_y_clear_en': (0, 0x06e, 15, True),
    'fast_a_dx_sel': (0, 0x070, 4, True),
    'fast_a_dy_sel': (0, 0x071, 4, True),
    'fast_a_rx_sel': (0, 0x072, 4, True),
    ...
    'fast_b_y_limit_min': (1, 0x052, 14, True),
    'fast_b_y_limit_max': (1, 0x054, 14, True),
    'fast_b_x_clr': (1, 0x056, 1, True),
    'fast_b_x_max': (1, 0x057, 25, False),
    'fast_b_x_min': (1, 0x05b, 25, False),
    'fast_b_y_clr': (1, 0x05f, 1, True),
    'fast_b_y_max': (1, 0x060, 25, False),
    'fast_b_y_min': (1, 0x064, 25, False),
    'fast_b_x_hold_en': (1, 0x068, 15, True),
    'fast_b_x_clear_en': (1, 0x06a, 15, True),
    'fast_b_y_hold_en': (1, 0x06c, 15, True),
    'fast_b_y_clear_en': (1, 0x06e, 15, True),
    'fast_b_dx_sel': (1, 0x070, 4, True),
    'fast_b_dy_sel': (1, 0x071, 4, True),
    'fast_b_rx_sel': (1, 0x072, 4, True),
    ...
    'root_control_signal_clr': (8, 0x036, 1, True),
    'root_control_signal_max': (8, 0x037, 25, False),
    'root_control_signal_min': (8, 0x03b, 25, False),
    'root_combined_error_signal_clr': (8, 0x03f, 1, True),
    'root_combined_error_signal_max': (8, 0x040, 25, False),
    'root_combined_error_signal_min': (8, 0x044, 25, False),
