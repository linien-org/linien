...
csr = {
    ...
    'logic_relock_watcher_lock_lost': (8, 0x10d, 1, False),
    'logic_relock_watcher_should_watch_control': (8, 0x10e, 1, True),
    'logic_relock_watcher_min_control': (8, 0x10f, 1, True),
    'logic_relock_watcher_max_control': (8, 0x110, 1, True),
    'logic_relock_watcher_should_watch_error': (8, 0x111, 1, True),
    'logic_relock_watcher_min_error': (8, 0x112, 1, True),
    'logic_relock_watcher_max_error': (8, 0x113, 1, True),
    'logic_relock_watcher_should_watch_monitor': (8, 0x114, 1, True),
    'logic_relock_watcher_min_monitor': (8, 0x115, 1, True),
    'logic_relock_watcher_max_monitor': (8, 0x116, 1, True),
    'logic_control_signal_clr': (8, 0x117, 1, True),
    'logic_control_signal_max': (8, 0x118, 25, False),
    'logic_control_signal_min': (8, 0x11c, 25, False),
    'logic_combined_error_signal_clr': (8, 0x120, 1, True),
    'logic_combined_error_signal_max': (8, 0x121, 25, False),
    'logic_combined_error_signal_min': (8, 0x125, 25, False),
