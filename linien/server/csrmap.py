...
csr = {
    ...
    'root_control_signal_clr': (8, 0x03b, 1, True),
    'root_control_signal_max': (8, 0x03c, 25, False),
    'root_control_signal_min': (8, 0x040, 25, False),
    'root_combined_error_signal_clr': (8, 0x044, 1, True),
    'root_combined_error_signal_max': (8, 0x045, 25, False),
    'root_combined_error_signal_min': (8, 0x049, 25, False),
