...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 261, 465))
        ...
        self.explainSweepOnAnalog = QtWidgets.QWidget(self.page_2)
        self.explainSweepOnAnalog.setObjectName("explainSweepOnAnalog")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.explainSweepOnAnalog)
        self.verticalLayout_16.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_16.setSpacing(6)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.label_21 = QtWidgets.QLabel(self.explainSweepOnAnalog)
        self.label_21.setObjectName("label_21")
        self.horizontalLayout_15.addWidget(self.label_21)
        self.label_22 = QtWidgets.QLabel(self.explainSweepOnAnalog)
        ...
        self.line_4 = QtWidgets.QFrame(self.explainSweepOnAnalog)
        ...
        self.label_19 = QtWidgets.QLabel(self.explainSweepOnAnalog)
        self.label_19.setObjectName("label_19")
        self.horizontalLayout_14.addWidget(self.label_19)
        self.label_20 = QtWidgets.QLabel(self.explainSweepOnAnalog)
        ...
        self.verticalLayout_15.addWidget(self.explainSweepOnAnalog)
        self.line_3 = QtWidgets.QFrame(self.page_2)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.verticalLayout_15.addWidget(self.line_3)
        self.explainNoSweepOnAnalog = QtWidgets.QWidget(self.page_2)
        self.explainNoSweepOnAnalog.setObjectName("explainNoSweepOnAnalog")
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout(self.explainNoSweepOnAnalog)
        self.horizontalLayout_18.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.label_25 = QtWidgets.QLabel(self.explainNoSweepOnAnalog)
        self.label_25.setObjectName("label_25")
        self.horizontalLayout_17.addWidget(self.label_25)
        self.label_26 = QtWidgets.QLabel(self.explainNoSweepOnAnalog)
        ...
        self.verticalLayout_15.addWidget(self.explainNoSweepOnAnalog)
        ...
        self.lockingPanel.setGeometry(QtCore.QRect(0, 0, 421, 451))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 391, 769))
        ...
        self.label_8 = QtWidgets.QLabel(self.auto_mode)
        self.label_8.setWordWrap(True)
        self.label_8.setIndent(30)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_10.addWidget(self.label_8)
        self.autoOffsetCheckbox = QtWidgets.QCheckBox(self.auto_mode)
        self.autoOffsetCheckbox.setChecked(True)
        self.autoOffsetCheckbox.setObjectName("autoOffsetCheckbox")
        self.verticalLayout_10.addWidget(self.autoOffsetCheckbox)
        self.label_9 = QtWidgets.QLabel(self.auto_mode)
        ...
        self.label_10 = QtWidgets.QLabel(self.auto_mode)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rampOnSlow.setText(_translate("MainWindow", "Sweep on analog output 0"))
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">FAST IN 2:</span></p></body></html>"))
        self.label_12.setText(_translate("MainWindow", "spectroscopy signal"))
        self.label_14.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">FAST OUT 1:</span></p></body></html>"))
        self.label_13.setText(_translate("MainWindow", "modulation frequency"))
        self.label_21.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">ANALOG OUT 0:</span></p></body></html>"))
        self.label_22.setText(_translate("MainWindow", "sweep"))
        self.label_19.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">FAST OUT2:</span></p></body></html>"))
        self.label_20.setText(_translate("MainWindow", "control signal"))
        self.label_25.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">FAST OUT2:</span></p></body></html>"))
        self.label_26.setText(_translate("MainWindow", "control signal and sweep"))
        ...
        self.label_8.setText(_translate("MainWindow", "Detects glitches and automatically relocks"))
        self.autoOffsetCheckbox.setText(_translate("MainWindow", "Determine signal offset"))
        self.label_9.setText(_translate("MainWindow", "Adapt offset such that lock is in the middle between minimum and maximum"))
        self.checkBox_4.setText(_translate("MainWindow", "Emit TTL when locked"))
        self.label_10.setText(_translate("MainWindow", "DIO0_N high when locked"))
